...
--	local inServiceTaxiCount = GetInServiceTaxiCount(name)
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('chat:addMessage', src, { args = { '^8TRABALHOS: ', 'Táxi: '..TaxiConnected } })
		TriggerClientEvent('chat:addMessage', src, { args = { '^8TRABALHOS: ', 'Mecânico: '..MechanicConnected} })
