...
drawText3D = function(x, y, z, text)
	...
	if onScreen then
        ...
        DrawRect(_x, _y + 0.0150, 0.030 + factor , 0.04, 63, 82, 104, 80)
	end
end

local blipmapa = {
	{ ['x'] = 241.38, ['y'] = 225.47, ['z'] = 106.29 },
}

local localmapa = {
	{ ['x'] = 241.38, ['y'] = 225.47, ['z'] = 106.29 },
	{ ['x'] = 243.21, ['y'] = 224.79, ['z'] = 106.29 },
	{ ['x'] = 246.57, ['y'] = 223.35, ['z'] = 106.29 },
	{ ['x'] = 248.4,  ['y'] = 222.94, ['z'] = 106.29 },
}
...
Citizen.CreateThread(function()
	while true do
		...
		for k,v in ipairs(localmapa) do
			if(Vdist(v.x, v.y, v.z, pos.x, pos.y, pos.z) < 20.0)then
				if(Vdist(v.x, v.y, v.z, pos.x, pos.y, pos.z) < 1.5)then
				drawText3D(v.x, v.y, v.z + 0.2, '[~g~E~s~] para acessar as ~b~faturas~s~')
...
Citizen.CreateThread(function()
  for k,v in ipairs(blipmapa)do
    ...
    AddTextComponentString("Pagar Faturas")
