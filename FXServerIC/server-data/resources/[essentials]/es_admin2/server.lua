...
-- adm chat
TriggerEvent('es:addGroupCommand', 'achat', "mod", function(source, args, user)
	
	TriggerClientEvent('chat:addMessage', -1, {
		args = {"^0[^8ADMIN^0] ".. GetPlayerName(source) .. ": " ..  table.concat(args, " ")}
	})

end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = {"^1SYSTEM ", "Insufficienct permissions!"} })
end, {help = "Escreva uma mensagem ", params = {{name = "anuncio ", help = "Mensagem para os players"}}})
...
--[[TriggerEvent('es:addGroupCommand', 'adm', "mod", function(source, args, user)
	...
	TriggerClientEvent('Adm', -1, 'importante', '<b>ADMINISTRADOR:</b></br>'.. table.concat(args, " ") )
...
TriggerEvent('es:addGroupCommand', 'adm2', "mod", function(source, args, user)

	TriggerClientEvent('Adm', -1, 'importante2', '<b>ADMINISTRADOR:</b></br>'.. table.concat(args, " ") )
...
TriggerEvent('es:addGroupCommand', 'achat2', "mod", function(source, args, user)
	if args[1] then
		if(tonumber(args[1]) and GetPlayerName(tonumber(args[1])))then
			local player = tonumber(args[1])
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				TriggerClientEvent('chat:addMessage', player, {
					args = {"^0[^8ADMIN^0] ".. GetPlayerName(source) .. "^2" .. reason .. "^0"}
				})				
...
TriggerEvent('es:addCommand', 'frp', function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, {
		args = {"^1[REPORTAR]", " ^5@" .. GetPlayerName(source) .. ", " .. source .. "^0: " .. table.concat(args, " ")}
	})
			...
			TriggerEvent("es:getPlayerFromId", k, function(user)
				if(user.getPermissions() > 0 and k ~= source)then
					TriggerClientEvent('chat:addMessage', k, {
						args = {"^1REPORTAR", " (^2" .. GetPlayerName(source) .." | "..source.."^0): " .. table.concat(args, " ")}
					})
				end
			end)
		end
	end)
end, {help = "Fale diretamente com um ADM", params = {{name = "frp", help = "Digite sua mensagem"}}})
...
TriggerEvent('es:addGroupCommand', 'nc', "mod", function(source, args, user)
	TriggerClientEvent("ic_menumod:admin_no_clip", source)
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end, {help = "Habilitar/Desablitar Noclip"})

TriggerEvent('es:addGroupCommand', 'godmod', "admin", function(source, args, user)
	TriggerClientEvent("ic_menumod:admin_godmod", source)
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end, {help = "Habilitar/Desablitar GODMOD"})

TriggerEvent('es:addGroupCommand', 'reparar', "admin", function(source, args, user)
	TriggerClientEvent("ic_menumod:admin_repair", source)
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end, {help = "Reparar veículo"})

TriggerEvent('es:addGroupCommand', 'dirtymoney', "admin", function(source, args, user)
	TriggerClientEvent("ic_menumod:admin_give_dirty", source)
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end, {help = "Dinheiro Sujo"})

TriggerEvent('es:addGroupCommand', 'tpway', "admin", function(source, args, user)
	TriggerClientEvent("ic_menumod:admin_tpway", source)
end, function(source, args, user)
	TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Insufficienct permissions!")
end, {help = "TP na marcação"})
	...
	if args[1] then
		if(tonumber(args[1]) and GetPlayerName(tonumber(args[1])))then
			...
			TriggerEvent("es:getPlayerFromId", player, function(target)
				...
				table.remove(reason, 1)
				if(#reason == 0)then
					reason = "Kikado: Você foi kikado do servidor."
				else
					reason = "Kikado: " .. table.concat(reason, " ")
				end

				TriggerClientEvent('chat:addMessage', -1, {
					args = {"^1SYSTEM", "^2" .. GetPlayerName(player) .. "^0 foi kikado, motivo:(^2" .. reason .. "^0)"}
				})
...
TriggerEvent('es:addGroupCommand', 'freeze', "mod", function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = {"^1SYSTEM", "Insufficienct permissions!"} })
end, {help = "Congelar/Descongelar um jogador", params = {{name = "userid", help = "The ID of the player"}}})
...
TriggerEvent('es:addGroupCommand', 'bring', "mod", function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = {"^1SYSTEM", "Insufficienct permissions!"} })
end, {help = "Puxar um jogador", params = {{name = "userid", help = "The ID of the player"}}})
...
TriggerEvent('es:addGroupCommand', 'goto', "mod", function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = {"^1SYSTEM", "Insufficienct permissions!"} })
end, {help = "Ir até um jogador.", params = {{name = "userid", help = "The ID of the player"}}})
