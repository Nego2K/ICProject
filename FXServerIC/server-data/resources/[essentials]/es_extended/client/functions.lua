...
ESX.Game.SpawnVehicle = function(modelName, coords, heading, cb)
	...
	Citizen.CreateThread(function()
		...
		local blipVehicle = AddBlipForEntity(vehicle)
		local classe = GetVehicleClassFromName(model)
		
		if classe == 8 then
			SetBlipSprite (blipVehicle, 552)
		elseif classe == 13 then
			SetBlipSprite (blipVehicle, 226)
		elseif classe == 14 then
			SetBlipSprite (blipVehicle, 427)
		elseif classe == 15 then
			SetBlipSprite (blipVehicle, 43)
		elseif classe == 16 then
			SetBlipSprite (blipVehicle, 307)
		elseif classe == 18 then
			SetBlipSprite (blipVehicle, 56)
		elseif classe == 19 then
			SetBlipSprite (blipVehicle, 560)
		else
			SetBlipSprite (blipVehicle, 523)
		end
		...
		SetBlipScale  (blipVehicle, 0.8)
		SetBlipColour (blipVehicle, 82)
		...
		AddTextComponentSubstringPlayerName('Veículo Pessoal')
...
ESX.ShowInventory = function()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'inventory', {
		title    = _U('inventory', currentWeight + .0, ESX.PlayerData.maxWeight + .0),
		align    = 'bottom-right',
		elements = elements
	}, function(data, menu)
		menu.close()
