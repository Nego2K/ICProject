...
ALTER TABLE `users`
	...
	ADD COLUMN `job` VARCHAR(50) NULL DEFAULT 'desempregado' AFTER `skin`,
...
INSERT INTO `job_grades` VALUES (1,'desempregado',0,'desempregado','Autônomo',200,'{}','{}');
...
INSERT INTO `jobs` VALUES ('desempregado','Desempregado');
